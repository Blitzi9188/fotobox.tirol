...
export default async function PreisgestaltungPage() {
  ...
  const references = [
    ...
    { name: "Donau Versicherung", href: "https://www.donauversicherung.at", logoDomain: "donauversicherung.at" },
    {
      ...
      logoSrc:
        "https://www.tirolwerbung.at/_Resources/Static/Packages/imx.bestpractice/images/PageHeader/tirol.svg?bust=20775f4e"
    },
    {
      ...
      <main>
        <section className="page-hero seo-landing-hero">
          <div className="container">
            ...
            <p>
              Eigene Uebersichtsseite fuer Pakete, Druckformate und Leistungen.
              Lokal zum Testen, ohne die Hauptnavigation zu aendern.
            </p>
          </div>
        </section>
        ...
        <section className="seo-landing-section">
          <div className="container">
            <h2><SlashHeading value="all/inclusive" /></h2>
        ...
        <section className="seo-landing-section">
          <div className="container">
            <h2><SlashHeading value="technik/bedienung" /></h2>
        ...
        <section className="seo-landing-section seo-landing-alt">
          <div className="container">
            <h2><SlashHeading value="referenzen/partner" /></h2>
          ...
          <div className="container">
            <aside className="pricing-contact-block">
              ...
              <div className="pricing-contact-lines">
                <p><strong>Telefon:</strong> <a href="tel:+436643918228">+43 664 3918 228</a></p>
                <p><strong>E-Mail:</strong> <a href="mailto:info@fotobox.tirol">info@fotobox.tirol</a></p>
                <p><strong>Adresse:</strong> Rohracker 6 | 6092 Birgitz</p>
              </div>
            </aside>
          </div>
        </section>
